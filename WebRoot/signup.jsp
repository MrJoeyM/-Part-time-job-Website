  ...
  <head>
    ...
    <script type="text/javascript">		   				
			...
			{	
				...
				regForm.university.value = htmlEncode(regForm.university.value);
				if(regForm.university.value == "")
				{
					regForm.university.focus();
					return;
				}
				...
				regForm.action = "<%=path%>/servlet/SignServlet?from=signup";
				regForm.submit();		
			}
		</script>
</head>
<body background="img/bgs/10.jpg" style="width:100%;height:100%;">
    ...
    <div class="login-wrapper" style="margin-top:-40">
        <div class="box">
            <div class="content-wrap" style="margin-top:-15">
                <h6>注册</h6>
                <form name="regForm" action="" method="post" style="margin-top:-13">
					...
					<input class="form-control" name="university" type="text" placeholder="就读大学" style="margin-top:10">
					<input class="form-control" name="contact" type="text" placeholder="联系方式" style="margin-top:10">
        ...
        <div class="already" style="margin-top:15">
            <p>已有账号？</p>
